      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
             ...
             <li class="nav-item">
              <a class="nav-link" href="tambah_jurusan.php">Tambah Data Jurusan</a>
            </li>
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered">
                       ...
                       <!-- <th>ID Jurusan</th>  -->
                            ...
                            echo "<tr>";
                                ...
                                echo "<td>".$row['nip']."</td>";
                                echo "<td>";
                                echo "<a href=ubah_jurusan.php?id_jurusan=".$row['id_jurusan'].">Edit</a> | ";
                                echo "<a href=delete_jurusan.php?id_jurusan=".$row['id_jurusan'].">Hapus </a>";
                                echo "</td>";        
                            echo "</tr>";
                            }
                            ?>
